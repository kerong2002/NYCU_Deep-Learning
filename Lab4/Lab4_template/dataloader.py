...
if __name__ == "__main__":
    ...
    dataset = Dataset_Dance(root="../LAB4_Dataset/LAB4_Dataset", transform=transform, mode='test', video_len=16, \
                                                partial=1.0)
    cat = torch.concat((dataset[0][0], dataset[0][1]), dim=3)
    print(cat.shape)
    save_image(cat[0], "test.png")